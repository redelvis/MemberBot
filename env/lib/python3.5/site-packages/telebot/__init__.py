...
import logging  # import tracking

logger = logging.getLogger('TeleBot')  # giving var logger value of method getLogger from file loggin.py with TeleBot # as argument
formatter = logging.Formatter(
    '%(asctime)s (%(filename)s:%(lineno)d %(threadName)s) %(levelname)s - %(name)s: "%(message)s"'
) #same but we took Formatter method with 7 different arguments
...
class TeleBot: #here we are starting main class. Every object will be like that
